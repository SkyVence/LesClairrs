...
var AllImplants = []Implant{
    ...
    },
    {
        ...
        Skill:     "smash",
        Description: "Smash : enleve 30% des pv (CD: 3 tours)",
        Cooldown: 3,
        SkillEffect: func(player *Player, enemy *Enemy) {
            enemy.CurrentHP -= int(float64(enemy.MaxHP) * 0.3)
            fmt.Println(player.Name, "utilise Smash : enleve 30% des pv de l'ennemi !")
        },
    },
    {
